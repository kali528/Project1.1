		...
		<ul class="sidebar-menu" data-widget="tree">
		  ...
		  <li class="treeview">
			...
			<ul class="treeview-menu">
			  <li><a href="AdminLTE-2.4.2/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
			  <li><a href="AdminLTE-2.4.2/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
			</ul>
		  </li>
		  <li class="treeview">
			<a href="#">
			...
			<ul class="treeview-menu">
			  <li><a href="AdminLTE-2.4.2/layout/top-nav.html"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
			  <li><a href="AdminLTE-2.4.2/layout/boxed.html"><i class="fa fa-circle-o"></i> Boxed</a></li>
			  <li><a href="AdminLTE-2.4.2/layout/fixed.html"><i class="fa fa-circle-o"></i> Fixed</a></li>
			  <li><a href="AdminLTE-2.4.2/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
			</ul>
		  </li>
		  <li>
			<a href="AdminLTE-2.4.2/widgets.html">
		  ...
		  <li class="treeview">
			...
			<ul class="treeview-menu">
			  <li><a href="AdminLTE-2.4.2/charts/chartjs.html"><i class="fa fa-circle-o"></i> ChartJS</a></li>
			  <li><a href="AdminLTE-2.4.2/charts/morris.html"><i class="fa fa-circle-o"></i> Morris</a></li>
			  <li><a href="AdminLTE-2.4.2/charts/flot.html"><i class="fa fa-circle-o"></i> Flot</a></li>
			  <li><a href="AdminLTE-2.4.2/charts/inline.html"><i class="fa fa-circle-o"></i> Inline charts</a></li>
			</ul>
		  </li>
		  <li class="treeview">
			<a href="#">
			...
			<ul class="treeview-menu">
			  <li><a href="AdminLTE-2.4.2/UI/general.html"><i class="fa fa-circle-o"></i> General</a></li>
			  <li><a href="AdminLTE-2.4.2/UI/icons.html"><i class="fa fa-circle-o"></i> Icons</a></li>
			  <li><a href="AdminLTE-2.4.2/UI/buttons.html"><i class="fa fa-circle-o"></i> Buttons</a></li>
			  <li><a href="AdminLTE-2.4.2/UI/sliders.html"><i class="fa fa-circle-o"></i> Sliders</a></li>
			  <li><a href="AdminLTE-2.4.2/UI/timeline.html"><i class="fa fa-circle-o"></i> Timeline</a></li>
			  <li><a href="AdminLTE-2.4.2/UI/modals.html"><i class="fa fa-circle-o"></i> Modals</a></li>
			</ul>
		  </li>
		  <li class="treeview">
			<a href="#">
			...
			<ul class="treeview-menu">
			  <li><a href="AdminLTE-2.4.2/forms/general.html"><i class="fa fa-circle-o"></i> General Elements</a></li>
			  <li><a href="AdminLTE-2.4.2/forms/advanced.html"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
			  <li><a href="AdminLTE-2.4.2/forms/editors.html"><i class="fa fa-circle-o"></i> Editors</a></li>
			</ul>
		  </li>
		  <li class="treeview">
			<a href="#">
			...
			<ul class="treeview-menu">
			  <li><a href="AdminLTE-2.4.2/tables/simple.html"><i class="fa fa-circle-o"></i> Simple tables</a></li>
			  <li><a href="AdminLTE-2.4.2/tables/data.html"><i class="fa fa-circle-o"></i> Data tables</a></li>
			</ul>
		  </li>
		  <li>
			<a href="AdminLTE-2.4.2/calendar.html">
		  ...
		  <li>
			<a href="AdminLTE-2.4.2/mailbox/mailbox.html">
